...
local radar_detection_distance = { blue = 30000, red = 30000 } -- distanza massima di rilevamento dei radar
local gci_interception_distance = { blue = 55000, red = 50000 } -- distanza massima di attivazione GCI = 70 km (rispetto le aribase)
local airborne_engaging_distance = { blue = 45000, red = 30000 } -- distanza massima autorizzazione all'ingaggio per aerei alleati nelle vicinanze
